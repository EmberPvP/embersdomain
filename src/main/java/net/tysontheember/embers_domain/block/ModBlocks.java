package net.tysontheember.embers_domain.block;
...
import net.tysontheember.embers_domain.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, EmbersDomain.MOD_ID);
    ...
    public static final RegistryObject<Block> NETHER_MITHRIL_ORE = registerBlock("nether_mithril_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.NETHERRACK)
                    .strength(1f).requiresCorrectToolForDrops(), UniformInt.of(3, 7)));
    public static final RegistryObject<Block> END_STONE_MITHRIL_ORE = registerBlock("end_stone_mithril_ore",
